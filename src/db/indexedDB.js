...
export const prePopulateDB = async () => {
  const sampleVehicles = [
    { name: "Rally Car A", number: "101", team: "Equipe Alpha", pilot: "João Silva" },
    { name: "Eco Buggy", number: "202", team: "Equipe Beta", pilot: "Maria Santos" },
    { name: "Green Runner", number: "303", team: "Equipe Gamma", pilot: "Pedro Oliveira" },
    { name: "Electric Racer", number: "404", team: "Equipe Delta", pilot: "Ana Pereira" },
    { name: "Hybrid Speed", number: "505", team: "Equipe Alpha", pilot: "Carlos Mendes" }
  ];
